          ...
          <div className="row">
            <div className="col-md-4">
              <div className="content">
                ...
                <p className="py-3 h4">
                  Aonflow is the best integration
                  <br />
                  platform (iPaaS) to connect
                  <br />
                  applications and to automate
                  <br />
                  your business
                </p>
                <div className="row">
      ...
      <section>
        <div className="container">
          <div className="text-center section-2-text">
            ...
            <p>
              iPaaS, or integration Platform as a Service, are platforms that
              standardize how applications are integrated into an organization,
              making it easier to automate business processes and share data
              across applications.
            </p>
          ...
          <div className="row text-white py-4">
            <div className="col-md-4">
              ...
              <p>
                ...
                <br /> amet sint. Velit officia consequat duis
                <br /> enim velit mollit. Exercitation <br />
